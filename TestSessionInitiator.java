...
import com.qait.demo.keywords.MoveToTechAction;
import com.qait.demo.keywords.TOIFetchNewsAction;
import com.qait.demo.keywords.TOIHomePageAction;
...
public class TestSessionInitiator {
	...
	public TOIHomePageAction toiHomePageAction;
	public TOIFetchNewsAction toiFetchNewsAction;
	public MoveToTechAction moveToTechAction;
	...
	toiHomePageAction=new TOIHomePageAction(driver);
	toiFetchNewsAction=new TOIFetchNewsAction(driver);
	moveToTechAction=new MoveToTechAction(driver);
	...
	public void launchApplication() {
		launchApplication(getYamlValue("baseURL_TOI"));
	}
